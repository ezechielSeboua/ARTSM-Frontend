const EarthLoader = ({ size = 7.5, text = "Connecting..." }) => {
  const scale = size / 7.5; // 7.5 est la taille par défaut en em
  ...
  return (
    <>
      ...
      >
        {/* Conteneur dimensionné pour contenir la sphère redimensionnée */}
        <div
          style={{
            width: size + "em",
            height: size + "em",
