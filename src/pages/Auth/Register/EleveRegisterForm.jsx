      ...
      <div className="w-full sm:max-w-2xl bg-white sm:rounded-3xl border-0 sm:border border-slate-200/60 shadow-2xl shadow-slate-200/50 overflow-hidden relative z-10 mt-0 sm:mt-16 rounded-none">
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="text-white/60 text-xs sm:text-sm mt-1 hidden sm:block">
                  Pour les élèves inscrits dans un établissement ARSTM
                </p>
              </div>
            </div>
            <Link
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-10 space-y-6 sm:space-y-8">
          ...
          <div className="space-y-3 sm:space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4">
              ...
              <div className="sm:col-span-2">
                ...
                >
                  <option value="">
                    {schoolsLoading ? 'Chargement...' : "Sélectionnez votre école..."}
                  </option>
                  {schools.map((s) => (
          ...
          <button
            ...
            className="w-full py-3 sm:py-4 bg-blue-950 hover:bg-blue-900 disabled:opacity-60 text-white font-bold rounded-2xl shadow-xl shadow-blue-950/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 text-sm sm:text-base"
          >
            {regLoading ? (
...
export default EleveRegisterForm;
