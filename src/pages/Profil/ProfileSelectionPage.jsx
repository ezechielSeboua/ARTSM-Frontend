...
const profiles = [
  {
    id: "eleves",
    title: "Élève",
    description: "Déjà inscrit dans un établissement ARSTM. Accédez à votre espace scolaire.",
    badge: "Scolarité",
    badgeColor: "text-blue-700 bg-blue-50",
    targetUrl: "/register/eleves",
    icon: (
  ...
  },
  {
    id: "candidats",
    title: "Candidat",
    description: "Vous souhaitez passer un concours d'admission dans une école ARSTM.",
    badge: "Concours",
